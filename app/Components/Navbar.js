...
const Navbar = () => {
  return (
    <div className="Navbar flex items-center justify-between w-full p-4 bg-white shadow-md">
        ...
        <div className="flex flex-1 justify-end gap-8">
          <div className="flex items-center gap-9">
            ...
            <a className="text-[#111217] text-sm font-medium leading-normal" href="#">Learn</a>
            <a className="text-[#111217] text-sm font-medium leading-normal" href="#">Blog</a>
            <a className="text-[#111217] text-sm font-medium leading-normal" href="#">Portfolio</a>
            <a className="text-[#111217] text-sm font-medium leading-normal" href="#">Contact</a>
          </div>
          <button
